...
namespace SmartHousing.API.Database.Seed
{
  public static class SeedData
  {
    ...
    public static List<Water> Water = new List<Water>
    {
      ...
      new Water { Id = 31, Amount = 89.21, TarriffId = 1 },
      new Water { Id = 32, Amount = 72.91, TarriffId = 2 },
      new Water { Id = 33, Amount = 17.91, TarriffId = 1 },
      new Water { Id = 34, Amount = 79.12, TarriffId = 2 },
      new Water { Id = 35, Amount = 68.57, TarriffId = 1 },
      new Water { Id = 36, Amount = 78.12, TarriffId = 2 },
      new Water { Id = 37, Amount = 56.91, TarriffId = 1 },
      new Water { Id = 38, Amount = 88.61, TarriffId = 2 },
      new Water { Id = 39, Amount = 78.51, TarriffId = 1 },
      new Water { Id = 40, Amount = 87.21, TarriffId = 2 },
      new Water { Id = 41, Amount = 83.21, TarriffId = 1 },
      new Water { Id = 42, Amount = 14.23, TarriffId = 2 },
      new Water { Id = 43, Amount = 98.21, TarriffId = 1 },
      new Water { Id = 44, Amount = 101.32, TarriffId = 2 },
      new Water { Id = 45, Amount = 78.32, TarriffId = 1 },
      new Water { Id = 46, Amount = 80.56, TarriffId = 2 },
      new Water { Id = 47, Amount = 69.12, TarriffId = 1 },
      new Water { Id = 48, Amount = 71.45, TarriffId = 2 },
      new Water { Id = 49, Amount = 84.91, TarriffId = 1 },
      new Water { Id = 50, Amount = 71.67, TarriffId = 2 }
    };

    public static List<Electricity> Electricity = new List<Electricity>
    {
      new Electricity { Id = 1, Amount = 100.21, TarriffId = 1 },
      new Electricity { Id = 2, Amount = 81.21, TarriffId = 1 },
      ...
      new Electricity { Id = 8, Amount = 71.91, TarriffId = 1 },
      new Electricity { Id = 9, Amount = 87.51, TarriffId = 1 },
      new Electricity { Id = 10, Amount = 90.56, TarriffId = 1 },
      new Electricity { Id = 11, Amount = 81.91, TarriffId = 2 },
      new Electricity { Id = 12, Amount = 67.91, TarriffId = 2 },
      new Electricity { Id = 13, Amount = 89.51, TarriffId = 2 },
      new Electricity { Id = 14, Amount = 86.91, TarriffId = 2 },
      new Electricity { Id = 15, Amount = 71.56, TarriffId = 2 },
      ...
      new Electricity { Id = 19, Amount = 62.21, TarriffId = 2 },
      new Electricity { Id = 20, Amount = 69.91, TarriffId = 3 },
      new Electricity { Id = 21, Amount = 67.51, TarriffId = 3 },
      new Electricity { Id = 22, Amount = 81.56, TarriffId = 3 },
      new Electricity { Id = 23, Amount = 51.21, TarriffId = 3 },
      ...
      new Electricity { Id = 27, Amount = 41.56, TarriffId = 3 },
      new Electricity { Id = 28, Amount = 81.21, TarriffId = 3 },
      new Electricity { Id = 29, Amount = 71.21, TarriffId = 3 },
      new Electricity { Id = 30, Amount = 78.51, TarriffId = 1 },
      new Electricity { Id = 31, Amount = 46.61, TarriffId = 2 },
      new Electricity { Id = 32, Amount = 69.11, TarriffId = 3 },
      new Electricity { Id = 33, Amount = 54.21, TarriffId = 1 },
      new Electricity { Id = 34, Amount = 79.61, TarriffId = 2 },
      new Electricity { Id = 35, Amount = 91.91, TarriffId = 3 },
      new Electricity { Id = 36, Amount = 99.12, TarriffId = 1 },
      new Electricity { Id = 37, Amount = 101.91, TarriffId = 2 },
      new Electricity { Id = 38, Amount = 60.98, TarriffId = 3 },
      new Electricity { Id = 39, Amount = 71.31, TarriffId = 1 },
      new Electricity { Id = 40, Amount = 75.91, TarriffId = 2 },
      new Electricity { Id = 41, Amount = 68.39, TarriffId = 3 },
      new Electricity { Id = 42, Amount = 91.54, TarriffId = 1 },
      new Electricity { Id = 43, Amount = 71.96, TarriffId = 2 },
      new Electricity { Id = 44, Amount = 72.61, TarriffId = 3 },
      new Electricity { Id = 45, Amount = 81.61, TarriffId = 1 },
      new Electricity { Id = 46, Amount = 76.90, TarriffId = 2 },
      new Electricity { Id = 47, Amount = 28.31, TarriffId = 3 },
