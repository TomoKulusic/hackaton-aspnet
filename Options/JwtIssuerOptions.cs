...
namespace SmartHousing.Options
{
  public class JwtIssuerOptions
  {
    ...
    public SigningCredentials SigningCredentials
    {
      get
      {
        if (_signingCredentials == null && SigningToken != null)
        {
    ...
    public SymmetricSecurityKey Key
    {
      get
      {
        if (_symetricSecurityKey == null && SigningToken != null)
        {
          _symetricSecurityKey = new SymmetricSecurityKey(Encoding.ASCII.GetBytes(SigningToken));
        }
        return _symetricSecurityKey;
      }
    }


    /// <summary>
    /// The signing token used to generate Signing Credentials  
    /// </summary>
